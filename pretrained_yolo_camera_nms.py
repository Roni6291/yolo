...
while True:
    ...
    # of blob is 320,320
    # accepted sizes are 320×320,416×416,609×609. More size means more accuracy
    # but less speed
    ...
    for object_detection_layer in obj_detection_layers:
        ...
        for object_detection in object_detection_layer:
            ...
            if prediction_confidence > 0.20:
                ...
                ############## NMS Change 2 ###############
                # save class id, start x, y, width & height, confidences in a
                # list for nms processing
    ...
    # Non-Maxima Suppression confidence set as 0.5 & max_suppression threhold

...
img_to_detect = cv2.imread('images/testing/scene8.jpg')
...
# recommended by yolo authors, scale factor is 0.003922=1/255, width,height
# of blob is 320,320 accepted sizes are 320×320,416×416,609×609. More size
# means more accuracy but less speed
...
for object_detection_layer in obj_detection_layers:
    ...
    for object_detection in object_detection_layer:
        ...
        # obj_detections[1 to 4] => will have the two center points,

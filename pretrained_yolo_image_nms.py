...
# recommended by yolo authors, scale factor is 0.003922=1/255, width,height of
# blob is 320,320
# accepted sizes are 320×320,416×416,609×609. More size means more accuracy but
# less speed
...
class_labels = ["person", "bicycle", "car", "motorcycle", "airplane", "bus",
                ...
                "hotdog", "pizza", "donut", "cake", "chair", "sofa",
                "pottedplant", "bed", "diningtable", "toilet", "tvmonitor",
                "laptop", "mouse", "remote", "keyboard", "cellphone",
...
class_colors = ["0,255,0", "0,0,255", "255,0,0", "255,255,0", "0,255,255",
                "255,0,255", "224,187,228", "254,200,216", "255,223,211",
                "141,212,205"]
class_colors = [np.array(every_color.split(",")).astype("int") for every_color
                in class_colors]
class_colors = np.array(class_colors)
class_colors = np.tile(class_colors, (8, 1))

# Loading pretrained model
# input preprocessed blob into model and pass through the model
# obtain the detection predictions by the model using forward() method
yolo_model = cv2.dnn.readNetFromDarknet('model/yolov3.cfg',
...
for object_detection_layer in obj_detection_layers:
    ...
    for object_detection in object_detection_layer:
        ...
        # obj_detections[1 to 4] => will have the two center points, box width
        # and box height
        # obj_detections[5] => will have scores for all objects within
        # bounding box
        ...
        if prediction_confidence > 0.20:
            ...
            boxes_list.append([start_x_pt, start_y_pt,
...
# Non-Maxima Suppression confidence set as 0.5 & max_suppression threhold for
# NMS as 0.4 (adjust and try for better perfomance)
